...
public class Main {
	...
	private static void readLineByLineExample() throws IOException {
		System.out.println("\n**** readLineByLineExample ****");
		String csvFilename = "C:\\Users\\mine\\Desktop\\WebServices\\excelReadtest\\sample.csv";
	...
	private static void writeCSVExample() throws IOException {
		...
		String csv = "C:\\Users\\mine\\Desktop\\WebServices\\excelReadtest\\output.csv";
	...
	private static void writeAllExample() throws IOException {
		...
		String csv = "C:\\Users\\mine\\Desktop\\WebServices\\excelReadtest\\output2.csv";
		CSVWriter writer = new CSVWriter(new FileWriter(csv));
